...
class DS_Block(nn.Module):
    def __init__(self, in_channel=2, predict=False, out_channel=128, k_num=8, sampling_rate=0.5):
...
class MyCLNet(nn.Module):
    def __init__(self, in_channel):
        super(MyCLNet, self).__init__()

        self.ds_0 = DS_Block(in_channel=in_channel,predict=False, out_channel=128, k_num=9, sampling_rate=1.0)
...
class score_model(nn.Module):
    def __init__(self, sample_size=5, branches_out=2):
        super().__init__()
        self.mlp1 = MultiLayerPerceptron([256,256, 256],
                                         hidden_act=leaky_relu,
                                         final_act=leaky_relu,)
        self.mlp2 = MultiLayerPerceptron([512,256, 128],
                                         hidden_act=leaky_relu,
                                         final_act=leaky_relu,)
