...
from .multi_head_attention_v6 import MultiheadAttention_v6
from .utils import _get_activation_fn


class TransformerDecoderLayer_v6(nn.Module):
    ...
    def __init__(self, version, d_model, nhead, dim_feedforward=2048, dropout=0.1,
        ...
        self.multihead_attn = MultiheadAttention_v6(version, d_model, nhead, dropout=dropout)
