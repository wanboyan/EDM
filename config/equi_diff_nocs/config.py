...
flags.DEFINE_string('occ_r_path','./weights/occ_r.pt', '')
flags.DEFINE_string('latent_dir','./weights/latent/equi_inv_52499','')

flags.DEFINE_string('occ_latent_dir','./weights/latent/occ_24999','')
...
flags.DEFINE_integer('point_emb',0, '')
...
flags.DEFINE_string('cloud_dir', './weights/cloud', 'path to the dataset')
...
flags.DEFINE_string('model_save', 'output/equi_diff_nocs', 'path to save checkpoint')
...
# flags.DEFINE_string('resume_model_name', 'model_49.pth','')
