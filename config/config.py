...
flags.DEFINE_string('dataset_dir', '/home/wanboyan/Documents/cmr-master/data', 'path to the dataset')
flags.DEFINE_string('detection_dir', '/home/wanboyan/Documents/cmr-master/data/GPV/segmentation_results', 'path to detection results')
flags.DEFINE_string('per_obj', 'bottle', 'only train an specified object')
...
flags.DEFINE_string('model_save', 'output/gpv_per', 'path to save checkpoint')
# resume
