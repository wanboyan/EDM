...
flags.DEFINE_integer('pad_num', 100, '')
flags.DEFINE_float('query_radius', 0.6, '')
flags.DEFINE_float('pad_radius', 0.6, '')


flags.DEFINE_integer('fake_grid_num', 500, '')
...
flags.DEFINE_integer('use_sampling_test',0, '')
flags.DEFINE_integer('test_topk',100, '')

flags.DEFINE_string('pic_save_dir', 'sampling_eval', '')
...
flags.DEFINE_integer('use_sampling_train',0, '')
flags.DEFINE_float('scale_ratio', 2, '')
flags.DEFINE_float('mask_ratio', 0.05, '')
flags.DEFINE_integer('aug_deform', 0, '')
flags.DEFINE_integer('aug_bg', 1, '')
...
flags.DEFINE_float('scale_constant', 64000, '')
...
flags.DEFINE_float('rot_1_w', 1.0, '')
flags.DEFINE_float('rot_2_w', 1.0, '')
flags.DEFINE_float('rot_regular', 0.5, '')
...
flags.DEFINE_float('aug_pc_pro', 0.8, 'probability to augment pc')
flags.DEFINE_float('aug_pc_r', 0.002, 'change 2mm')
flags.DEFINE_float('aug_rt_pro', 1, 'probability to augment rt')
flags.DEFINE_float('aug_bb_pro', 0.8, 'probability to augment size')
