...
flags.DEFINE_integer("num_workers", 0, "cpu cores for loading dataset")
flags.DEFINE_integer('batch_size', 16, '')
flags.DEFINE_integer('total_epoch', 70, 'total epoches in training')
flags.DEFINE_integer('train_steps', 500, 'number of batches in each epoch')  # batchsize is 8, then 3000
...
flags.DEFINE_string('model_save', 'output/v7_pips_t', 'path to save checkpoint')
