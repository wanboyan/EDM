...
flags.DEFINE_integer('train_steps', 400, 'number of batches in each epoch')  # batchsize is 8, then 3000
...
flags.DEFINE_string('model_save', 'output/NFwhole', 'path to save checkpoint')


# resume
flags.DEFINE_integer('resume', 0, '1 for resume, 0 for training from the start')
flags.DEFINE_string('resume_dir', '/home/wanboyan/Documents/cmr-master/extern/GPV_Pose-master/engine/output/CameraNF','')
flags.DEFINE_string('resume_model_name', 'model_99.pth','')
