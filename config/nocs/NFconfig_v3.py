...
flags.DEFINE_string('model_save', 'output/v3_scratch_4', 'path to save checkpoint')


# resume
flags.DEFINE_integer('resume', 1, '1 for resume, 0 for training from the start')
flags.DEFINE_string('resume_dir', 'output/v3_scratch_4','')
flags.DEFINE_string('resume_model_name', 'model_29.pth','')
