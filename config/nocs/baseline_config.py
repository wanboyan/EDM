...
flags.DEFINE_integer('train_steps', 100, 'number of batches in each epoch')  # batchsize is 8, then 3000
...
flags.DEFINE_string('model_save', 'output/baseline_model', 'path to save checkpoint')
# resume
flags.DEFINE_integer('resume', 1, '1 for resume, 0 for training from the start')
flags.DEFINE_string('resume_model', '/home/wanboyan/Documents/cmr-master/extern/GPV_Pose-master/engine/output/baseline_model/model_149.pth', 'path to the saved model')
