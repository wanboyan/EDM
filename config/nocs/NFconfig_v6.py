...
# eval
flags.DEFINE_string('eval_out', 'output/v7', '')
...
flags.DEFINE_integer('pic_save', 0, '')
...
flags.DEFINE_string('model_save', 'output/v7_normal', 'path to save checkpoint')


# resume
flags.DEFINE_integer('resume',0, '1 for resume, 0 for training from the start')
flags.DEFINE_string('resume_dir', '/home/wanboyan/Documents/cmr-master/extern/GPV_Pose-master/engine/output/v7','')
