...
flags.DEFINE_integer('total_epoch', 100, 'total epoches in training')
flags.DEFINE_integer('train_steps', 300, 'number of batches in each epoch')  # batchsize is 8, then 3000
...
flags.DEFINE_string('model_save', 'output/CameraNF', 'path to save checkpoint')


# resume
flags.DEFINE_integer('resume', 0, '1 for resume, 0 for training from the start')
flags.DEFINE_string('resume_dir', '/data_nvme/data_output/output/CamNFmodel','')
