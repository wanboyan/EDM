...
# eval
flags.DEFINE_string('eval_out', 'output/tmp', '')
...
flags.DEFINE_string('model_save', 'output/transfer', 'path to save checkpoint')


# resume
flags.DEFINE_integer('resume', 1, '1 for resume, 0 for training from the start')
flags.DEFINE_string('resume_dir', '/home/wanboyan/Documents/cmr-master/extern/GPV_Pose-master/output/NFwhole_prior_7','')
