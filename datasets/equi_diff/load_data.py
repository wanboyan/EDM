...
class PoseDataset(data.Dataset):
    def __init__(self,data_dir=None, obj_list=None,mode=''):
        ...
        self.cat_names=['03642806','03797390','02946921','02942699','02880940','02876657']
        ...
        if mode=='train':
            self.ds_dir = os.path.join(self.data_dir, 'train/ycbv/train_pbr')
            start = 0
            end = 22
            self.visib_fract_thresh = 0.15
        else:
            self.ds_dir = os.path.join(self.data_dir, 'test/ycbv/train_pbr')
            start = 0
            end = 1
            self.visib_fract_thresh = 0.0

        self.cloud_dir=os.path.join(self.data_dir,'cloud')
