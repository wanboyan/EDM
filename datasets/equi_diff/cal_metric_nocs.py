...
pred_result_save_path='/data_sata/pack/result/mid_con_v1_nocs_mug_sample_10_mean.pkl'
dataset_dir='/data_nvme/nocs_data'
detection_dir='/data_nvme/nocs_data/segmentation_results'
latent_dir='/data_sata/pack/latent/latent_49499_new'
...
for subfolder in subfolders:
    ...
    for obj_key in combine:
        ...
        # show_open3d(pred_cloud,gt_cloud_cam)
