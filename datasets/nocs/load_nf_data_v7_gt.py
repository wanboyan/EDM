...
class PoseDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        gt_index=self.img_list[index]+model_name
        ...
        regular_grid,_=make_regular_grid(FLAGS.regular_grid_spilt)


        data_dict = {}
        if FLAGS.train_pips_t:
            gt_index=gt_index.replace("/","_")
            gt_save_path=os.path.join(FLAGS.generated_gt_dir,cat_name,gt_index+'.pt')
            generated_gt_dict=torch.load(gt_save_path,map_location='cpu')
            data_dict['generated_gt_coord']=generated_gt_dict['coord'][0]
            data_dict['generated_gt_log_stds']=generated_gt_dict['log_stds'][0]
            data_dict['generated_gt_quat']=generated_gt_dict['quat'][0]





        data_dict['gt_index']=gt_index
        ...
        data_dict['regular_grid'] = torch.as_tensor(regular_grid,dtype=torch.float32).contiguous()
