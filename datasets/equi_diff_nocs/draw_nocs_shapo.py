...
if __name__ == '__main__':
    result_dir='/data_sata/pack/result/shapo_result_500'
    ...
    output_dir='/data_sata/pack/result/shapo_result_500_vis'
    ...
    for subfolder in subfolders:
        ...
        do_sim(subfolder,pred_obj_id_list,pred_obj_scale_list,pred_obj_R_list,
               pred_obj_t_list,cam_K,out_path=os.path.join(output_dir,f'{scene_id}_{im_id}_shapo.jpg'))
