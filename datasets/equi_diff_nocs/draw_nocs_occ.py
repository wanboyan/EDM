...
if __name__ == '__main__':
    result_dir='/data_sata/pack/result/nocs_occ_best'
    ...
    output_dir='/data_sata/pack/result/nocs_occ_best_vis'
    ...
    for subfolder in subfolders:
        ...
        for obj_index in combine:
            ...
            pred_dict=trans_scale_dict[obj_index]

            pred_obj_id_list.append(obj_index)
            pred_obj_scale_list.append(pred_dict['pred_scale'])
            pred_obj_R_list.append(pred_dict['pred_R'])
            pred_obj_t_list.append(pred_dict['pred_trans'])
        ...
        do_sim(subfolder,pred_obj_id_list,pred_obj_scale_list,pred_obj_R_list,
               pred_obj_t_list,cam_K,out_path=os.path.join(output_dir,f'{scene_id}_{im_id}_occ.jpg'))
