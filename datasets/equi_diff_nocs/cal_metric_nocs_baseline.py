...
result_dir='/data_sata/pack/result/gcasp_result'
...
for subfolder in tqdm(subfolders):
    ...
    for obj_index in combine:
        ...
        pred_t=pred_RTs[:3,3]
        pred_shape_scale=pred_scale
        pred_scale=pred_scale*factor
        ...
        try:
            ...
            print('error mesh')
            continue
        pred_norm=np.linalg.norm(pred_shape_scale)
        ...
        pred_cloud_cam=np.einsum('ij,pj->pi',pred_R,pred_cloud_norm)*np.linalg.norm(pred_scale)+pred_t
