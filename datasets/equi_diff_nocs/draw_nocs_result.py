...
if __name__ == '__main__':
    result_dir='/data_sata/pack/result/nocs_result_500'
    pred_result_save_path='/data_sata/pack/result/noce_500.pkl'
    ...
    output_dir='/data_sata/pack/result/nocs_result_500_vis'
    ...
    for subfolder in subfolders:
        ...
        for obj_key in combine:
            ...
            pred_mesh_path=os.path.join(subfolder,f"{obj_key}.obj")

            pred_obj_id_list.append(obj_key)
            pred_obj_scale_list.append(pred_scale)
            pred_obj_R_list.append(pred_R)
            pred_obj_t_list.append(np.array(pred_trans))
            ...
            gt_obj_id_list.append(gt_id+'.obj')
            gt_obj_scale_list.append(1)
            gt_obj_R_list.append(gt_R)
            gt_obj_t_list.append(np.array(no_re_gt_t))
